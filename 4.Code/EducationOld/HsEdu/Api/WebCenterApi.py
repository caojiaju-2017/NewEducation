...
class WebCenterApi(object):
    ...
    def Modi_Factory(request):
        ...
        if len(postDataList['image']) > 0:
            ...
            imgdata = base64.b64decode(postDataList['image'])
            print STATIC_ROOT
            file = open(os.path.join(os.path.join("/opt/toupiao/HsEdu/static","factory"),'%s.jpg'% factory.logoname), 'wb')
            file.write(imgdata)
            file.close()
    ...
    def openPage1(request):
        renterDict = {}
        return render(request, './home/page1.html', renterDict)

    @staticmethod
    @csrf_exempt
    def openPage2(request):
        renterDict = {}
        return render(request, './home/page2.html', renterDict)

    @staticmethod
    @csrf_exempt
    def openPage3(request):
        renterDict = {}
        return render(request, './home/page3.html', renterDict)
    ...
    def openPage4(request):
        renterDict = {}
        return render(request, './home/page4.html', renterDict)
